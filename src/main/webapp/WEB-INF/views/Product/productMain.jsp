		...
		<div class="row">
			<div class="col-lg-3">
				...
				<div class="list-group">
					<a class="list-group-item" href="productList1">캠핑</a> <a
						class="list-group-item" href="productList2">조명</a> <a
						class="list-group-item" href="productList3">기타</a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="carousel-inner" role="listbox">
				<div class="carousel-item">
					<img class="d-block img-fluid" alt="First slide"
						src="resources/Picture/ChaBakPlace1.jpg">
				</div>
				...
				<div class="carousel-item">
					<img class="d-block img-fluid" alt="Third slide"
						src="resources/Picture\ChaBakPlace3.JPG">
				</div>
			</div>
